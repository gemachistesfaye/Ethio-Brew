    ...
    <div className="min-h-screen bg-[#FDFCF8] flex items-center justify-center p-4">
      <div className="max-w-md w-full bg-white rounded-[40px] shadow-2xl p-12 border border-gray-50">
        <div className="text-center mb-10">
          ...
          <p className="text-gray-500">Sign in to your Ethio-Brew account</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex justify-end">
            <Link to="/forgot-password" className="text-sm text-[#006341] font-bold hover:underline">Forgot Password?</Link>
          </div>
        ...
        <p className="mt-10 text-center text-sm text-gray-500">
          Don't have an account? <Link to="/register" className="text-[#006341] font-bold">Register now</Link>
        </p>
      </div>
    </div>
  );

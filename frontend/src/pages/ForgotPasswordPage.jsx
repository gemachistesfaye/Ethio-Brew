      ...
      <div className="max-w-md w-full bg-white rounded-[40px] shadow-2xl p-8 md:p-12 border border-gray-50">
        {!success ? (
          ...
          <div className="text-center animate-in zoom-in-95 duration-500">
            ...
            <p className="text-gray-500 mb-8">We've sent a password reset link to <span className="font-bold text-gray-800">{email}</span>. Please check your inbox.</p>
            <Link to="/login" className="inline-block bg-gray-100 text-[#4B2C20] py-4 px-8 rounded-2xl font-bold hover:bg-gray-200 transition">
              Back to Login
            </Link>
          </div>
        )}
